...
import itsEducation from "@/public/its_education.png";
import hayatBiotech from "@/public/hayat_biotech.png";
import itti from "@/public/itti.png";
...
export const projectsData = [
	...
	},
	{
		...
		imageUrl: optixTec,
		description:
			"Optixtec is a SaaS platform for managing the contruction related projects,timesheets, and procurement management services.",
	},
	{
		title: "ITTI",
		tags: [
		...
		imageUrl: itti,
		description: "ITTI is a Nepal's largest IT gadget e-commerce platform.",
	},
	{
		title: "ITS Education",
		tags: [
		...
		imageUrl: itsEducation,
		description: "ITS Education is a platform for digital learning.",
	},
	{
		title: "Hayat Biotech",
		tags: [
		...
		imageUrl: hayatBiotech,
		description:
			"Hayat Biotech is a platform for managing the record of medication and medication trials.",
	},
] as const;
